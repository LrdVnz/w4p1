...
if ( num3 === 8 || num4 === 8 ){
  ...
  console.log("L'addizione tra i due numeri è 8");
} */
...
/* let totalShoppingCart = 59; 

let finalPrice = totalShoppingCart < 50 ? totalShoppingCart : totalShoppingCart + 10; 
 */
...
/* let blackFridayCart = totalShoppingCart - (totalShoppingCart * 0.20);
let blackFridayPrice = blackFridayCart < 50 ? blackFridayCart : blackFridayCart + 10; 

if (blackFridayPrice < 50) {
     console.log("spedizione gratuita!");
} else {
     console.log("aggiungi 10 euro di spedizione.");
}
console.log("Il prezzo finale del black Friday è " + blackFridayPrice)
 */
